...
def card_segmentation(image):
    ...
    width = 660  # Define the width of the output rectangle
    height = 920  # Define the height of the output rectangle
...
def main_loop():
    ...
    processed_image = card_segmentation(original_image)
